...
function NavigationMenuLink({
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        'text-foreground/50 bg-card hover:bg-primary/5 hover:text-primary/50 data-[active]:text-primary data-[active]:bg-primary/7 flex h-9 items-center gap-2 rounded-full px-4 text-sm font-medium transition-all ease-in [&_svg]:size-4',
        className,
      )}
      {...props}
    />
